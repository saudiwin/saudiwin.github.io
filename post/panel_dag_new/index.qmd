...
image: "../../files/img/headers/tornado.jpeg"
description: "I clarify the limitations of the current representation of panel data in causal frameworks and why these limitations lead to confusion about what causal methods can do with panel data."
categories: ["R","Fixed Effects", "Panel Data","Data Science"]
---
...
[^1]: NB: The formula above does not have the true independence symbol as it is not in base latex for whatever reason.
...
[^2]: Granted, if they had one, they probably wouldn't tell us about it.
...
knitr::include_graphics("../../files/img/panel1.png",error=F)
...
knitr::include_graphics("../../files/img/panel2.png",error=F)
