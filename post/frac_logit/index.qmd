...
image: "../../files/img/headers/stop.jpeg"
categories: ["R", "Limited Dependent Variables","Beta Regression"]
description: "The continuous Bernoulli model is a proposed alternative to the well-known fractional logit specification. I discuss in this blog post when that might or might not be the case."
---
